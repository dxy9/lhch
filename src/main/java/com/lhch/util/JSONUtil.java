...
//            log.error("JSON生成错误" + jge.getMessage());
//        } catch (IOException ioe) {
//            log.error("JSON输入输出错误" + ioe.getMessage());
//        }
//        return null;
    }
...
//            log.error(String.format("反序列化失败, 错误原因:%s", jpe.getMessage()));
//        } catch (JsonMappingException jme) {
//            log.error(String.format("反序列化失败, 错误原因:%s", jme.getMessage()));
//        } catch (IOException ioe) {
//            log.error(String.format("反序列化失败, 错误原因:%s", ioe.getMessage()));
//        }
//        return null;
    }
